      ...
      <main className="py-10">
        <div className="container-padding max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
            <div>
              <h1 className="text-3xl font-semibold">Community Lead Revenue</h1>
              <p className="text-slate-600">Track your earnings and performance across events.</p>
            ...
            <div className="flex flex-wrap gap-2 items-end">
              ...
              <Button variant="outline" onClick={() => navigate("/communitylead/activity")}>
                Back to Dashboard
              </Button>
            </div>
          </div>
          ...
          <Card className="border border-slate-200 bg-white shadow-sm rounded-2xl">
            <CardHeader>
              <CardTitle>Revenue by Event (with 10% Commission)</CardTitle>
            </CardHeader>
            <CardContent>
                    ...
                    <div key={r.event_id} className="border rounded p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-xs text-slate-600">Bookings: {r.bookings_count}</div>
                        </div>
