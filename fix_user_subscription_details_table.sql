-- Fix user_subscription_details table if it was created with wrong user_id type
-- Run this in your Supabase SQL Editor if you get foreign key constraint errors

-- First, drop the existing table if it exists (this will remove any data)
DROP TABLE IF EXISTS public.user_subscription_details CASCADE;
